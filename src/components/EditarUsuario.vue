    ...
    <v-container>
        ...
        <v-flex text-left p-10 style="border:red solid 1px;  border-radius: 25px; padding:10px 0px 10% 0px; ">
            ...
            <v-flex text-right pr-5>
                <v-btn @click="dialog=true; excluirid = usuario.id " icon color="#de3d52">
                ...
                <td id="conteudo">
                    ...
                    <div style="padding-left:15px; padding-top:20px;">
                        ...
                        <v-col cols="12" sm="12" class="input">
                            <v-text-field :value="usuario.name" @input="value => { usuarioEditado.name = value }" single-line solo rounded required dense></v-text-field>
                        </v-col>
                        <span>Email:</span>
                        <br>
                        <v-col cols="12" sm="12" class="input">
                            <v-text-field :value="usuario.email" @input="value => { usuarioEditado.email = value }" single-line solo rounded required dense></v-text-field>
                        </v-col>
                    </div>
                </td>
        ...
        <v-dialog v-model="dialog2" max-width="290">
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-flex>
                        <v-btn rounded text @click="dialog2 = false">
                            Fechar
                        </v-btn>
                    </v-flex>
                </v-card-actions>
